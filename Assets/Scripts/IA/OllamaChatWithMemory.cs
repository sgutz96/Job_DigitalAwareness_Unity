...
public class OllamaChatWithMemory : MonoBehaviour
{
    public string model = "mistral";
    private string apiUrl = "http://localhost:11434/api/generate";


    public string propBase = "Eres samantha vives en el 308 de la calle gillermo de ocan y trabajas de meserae en un bar";
    ...
    {
        // 1. Construir el historial del chat
        ...
        // 2. Preparar el objeto para la solicitud JSON
        ...
        // 3. Enviar solicitud HTTP a Ollama
        using (UnityWebRequest request = new UnityWebRequest(apiUrl, "POST"))
        {
            ...
            {
                // 4. Leer respuesta en streaming línea por línea
